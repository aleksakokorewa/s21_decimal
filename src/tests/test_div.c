...
START_TEST(s21_div_3) {
  int true_res = 0;
  s21_decimal val1 = {{0xAFC01362, 0x7B178963, 0x8CEDFE3C, 0x00150000}};
  s21_decimal val2 = {{0x0ED0D46A, 0x52F5F16A, 0x32B07EE1, 0x801B0000}};
  s21_decimal output;
  s21_decimal result = {{0xC92532CE, 0xC0898127, 0x59D5BF40, 0x80160000}};
  int s21_res = s21_div(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_div_6) {
  ...
  s21_decimal output;
  s21_decimal result = {{0x00000006, 0x00000000, 0x00000000, 0x801C0000}};
  int s21_res = s21_div(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_div_8) {
  ...
  s21_decimal output;
  s21_decimal result = {{0xAA9CFB73, 0x000003E6, 0x00000000, 0x001C0000}};
  int s21_res = s21_div(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_div_14) {
  ...
  s21_decimal output;
  s21_decimal result = {{0xFF3B72F0, 0x57D4CBF6, 0x021F9344, 0x001C0000}};
  int s21_res = s21_div(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_div_20) {
  ...
  s21_decimal output;
  s21_decimal result = {{0x00000324, 0x00000000, 0x00000000, 0x001B0000}};
  int s21_res = s21_div(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_div_31) {
  ...
  s21_decimal output;
  s21_decimal result = {{0x93E994BF, 0x00094D48, 0x00000000, 0x801C0000}};
  int s21_res = s21_div(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_div_33) {
  ...
  s21_decimal output;
  s21_decimal result = {{0xB6A58CB1, 0x0001505C, 0x00000000, 0x001C0000}};
  int s21_res = s21_div(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_div_36) {
  ...
  s21_decimal output;
  s21_decimal result = {{0xE08A3C12, 0xDE46D00E, 0x000000A4, 0x001B0000}};
  int s21_res = s21_div(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_div_40) {
  ...
  s21_decimal output;
  s21_decimal result = {{0x14EBF2E4, 0x5BB92B2F, 0x8860C2DC, 0x800F0000}};
  int s21_res = s21_div(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_div_42) {
  ...
  s21_decimal output;
  s21_decimal result = {{0xC29D6798, 0x27788122, 0x00000031, 0x801C0000}};
  int s21_res = s21_div(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_div_44) {
  ...
  s21_decimal output;
  s21_decimal result = {{0xA49C27FF, 0x30706B99, 0x0000E584, 0x801C0000}};
  int s21_res = s21_div(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_div_63) {
  ...
  s21_decimal output;
  s21_decimal result = {{0xF059EC54, 0x00000003, 0x00000000, 0x801C0000}};
  int s21_res = s21_div(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_div_67) {
  ...
  s21_decimal output;
  s21_decimal result = {{0x10D86CB1, 0x428B9A6A, 0x01796913, 0x001C0000}};
  int s21_res = s21_div(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_div_70) {
  ...
  s21_decimal output;
  s21_decimal result = {{0x7B0C2823, 0x7D70A7B7, 0x00001B2F, 0x801C0000}};
  int s21_res = s21_div(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_div_73) {
  ...
  s21_decimal output;
  s21_decimal result = {{0x5626B56F, 0x9D22AFE2, 0x000001D3, 0x001C0000}};
  int s21_res = s21_div(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_div_75) {
  ...
  s21_decimal output;
  s21_decimal result = {{0xFCFE8D9E, 0x42383E07, 0x00000000, 0x001C0000}};
  int s21_res = s21_div(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_div_85) {
  ...
  s21_decimal output;
  s21_decimal result = {{0xBAEA15F5, 0x062768CD, 0x00000000, 0x001C0000}};
  int s21_res = s21_div(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
Suite *test_div(void) {
  ...
  tcase_add_test(tc, s21_div_0000);
  tcase_add_test(tc, s21_div_000);
  tcase_add_test(tc, s21_div_00);
